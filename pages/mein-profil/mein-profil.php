...
$query_playersprofile_db = "SELECT * FROM players WHERE Name = '$UName'";
...
$query_playerspinwand_db = "SELECT * FROM ucp_profile_pinwand WHERE targetUser = '$UName'";
...
$query_playeranchievment_db = "SELECT * FROM achievments WHERE Name = '$UName'";
...
$query_userdataprofile_db = "SELECT * FROM userdata WHERE Name = '$UName'";
...
$query_ucpprofile_db = "SELECT * FROM ucp WHERE Name = '$UName'";
...
$query_cars_db = "SELECT * FROM vehicles WHERE Besitzer = '$UName'";
$cars_db = mysqli_query($connection, $query_cars_db) or die(mysqli_error());
$row_cars_db = mysqli_fetch_assoc($cars_db);
$totalRows_cars_db = mysqli_num_rows($cars_db);
...
/*
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "aboutmefield-new")) {
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "aboutmefield-new")) {
  ...
  //checkob eintrag existiert
  $check = mysqli_query($connection, "SELECT * FROM ucp WHERE Name='".$insertName."'");
    if (!$check)
    {
        die('Error: ' . mysqli_error($connection));
    }
    if(mysqli_num_rows($check) > 0){
      $updateSQL = "UPDATE ucp SET aboutmetext = '" .$insertText. "' WHERE Name = '" .$insertName."' ";              
      $Result1 = mysqli_query($connection, $updateSQL) or die(mysqli_error($connection));
    }else{
      //Wenn Eintrag nicht existent ist
      $insertSQL = "INSERT INTO ucp (`Name`, `aboutmetext`) VALUES ('" .$insertName. "', '" .$insertText. "')";
      $Result1 = mysqli_query($connection, $insertSQL) or die(mysqli_error($connection));
    }
    header("Location: mein-profil.php");
}
?>
<!DOCTYPE html>
<html>
         ...
         <?php } ?>
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              ...
              <form method="POST" name="aboutmefield-new">
						<div class="box-body">
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#fahrzeuge" data-toggle="tab"><i class="fa fa-car"></i> Fahrzeuge</a></li>
              <li><a href="#häuser" data-toggle="tab"><i class="fas fa-home"></i> Häuser</a></li>
              <li><a href="#lizenzen" data-toggle="tab"><i class="far fa-id-card"></i> Lizenzen</a></li>
            </ul>
            <div class="tab-content">
              <div class="active tab-pane" id="pinnwand">
                ...
                <hr>
                <?php
                $loop = mysqli_query($connection, "SELECT * FROM ucp_profile_pinwand WHERE targetUser = '$UName'")
             ...
             ?>
                ...
                <div class="post">
                  <div class="user-block">
                    <img class="img-circle img-bordered-sm" src="../../dist/img/samp/avatar/1-<?php echo $row['fromUserSkinID']; ?>.png" alt="user image">
                        <span class="username">
                          <a href="show/index.php?id=<?php echo $row['fromUser']; ?>"><?php echo $row["fromUser"]; ?> <?php isPlayerOnline($connection, $row['fromUser']); ?></a>
                        </span>
              ...
              <?php if($totalRows_cars_db == 0) { ?>
          <div class="alert alert-danger">
                <h4><i class="icon fa fa-ban"></i> Fehler!</h4>
                Der Spieler besitzt keine Fahrzeuge!
              </div>
        <?php  } else  { ?>
            <?php do { ?>
                <div class="box box-warning">
                  <div class="box-body box-profile">
                    <center><img class="img-responsive" src="../../dist/img/samp/cars/1-<?php echo $row_cars_db['Typ']; ?>.png" alt="Car"></center>
                    <h3 class="profile-username text-center"><?= getCarName($row_cars_db["Typ"]); ?></h3>
                  </div>
                <!-- /.box-body -->
              </div>
              <?php } while ($row_cars_db = mysqli_fetch_assoc($cars_db)); } ?>
              </div>
              <div class="tab-pane" id="häuser">
                  HÄUSER
              </div>
              <div class="tab-pane" id="lizenzen">
                  LIZENZEN
              </div>
              <!-- /.tab-pane -->
            </div>
