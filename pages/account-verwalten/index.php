    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="#"><i class="fa fa-pencil-alt"></i> <span>Account Verwalten</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Account Verwaltung
            <small>Hier kannst du deinen Account verwalten!</small>
          </h1>
        </section>
		...
		<!--
			<div class="row">
					...
					<div class="box box-warning">
						...
						<form name="pw-change">
							<div class="box-body">
								...
								<input type="password" class="form-control" name="password-change" placeholder="Passwort" required>
							</div>
							<div class="box-footer pull">
								<button class="btn btn-success pull-right" type="submit">Passwort ändern</button>
							</div>
						</form>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="box box-warning">
						<div class="box-header with-border">
							<h3 class="box-title">E-Mail ändern</h3>
						</div>
						<form name="email-change">
							<div class="box-body">
								<strong>E-Mail</strong>
								<input type="email" class="form-control" name="email-change" placeholder="E-Mail" required>
							</div>
							<div class="box-footer pull">
								<button class="btn btn-success pull-right" type="submit">E-Mail ändern</button>
							</div>
						</form>
					</div>
				</div>
			</div> -->
			<div class='alert alert-info' role='alert'><span class="fa fa-info-circle" style="font-size: 20px;"></span> Aktuell außer Betrieb.</div>
        </section><!-- /.content -->
	</div><!-- /.content-wrapper -->
