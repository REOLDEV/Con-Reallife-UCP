...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "editrangform")) {
	$updaterang = mysqli_escape_string($connection, $_POST['updaterang_rang']);
	$updatename = mysqli_escape_string($connection, $_POST['updaterang_name']);
	$updateSQL = "UPDATE userdata SET FraktionsRang = '" .$updaterang. "' WHERE Name = '" .$updatename. "'";
  $Result1 = mysqli_query($connection, $updateSQL) or die(mysqli_error());
  header(sprintf("Location: index.php#rga"));
}
...
$query_userdataall_db = "SELECT * FROM userdata WHERE Fraktion = '$fraktionsid' AND Name = '$editranguser'";
            	...
            	<div class="col-md-6">
                    <div class="box box-warning">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-edit"></i> Benutzerrang von <?php echo $editranguser; ?> ändern</h3>
                            <div class="box-tools pull-right">
                                <a href="index.php" class="btn btn-box-tool"><i class="fa fa-times"></i></a>
                            </div><!-- /.box-tools -->
                        </div><!-- /.box-header -->
                        <form method="POST" name="editrangform">
                        <div class="box-body">
                   	  <select name="updaterang_rang" class="form-control" required>
                            	<option value="0" <?php if($row_userdataall_db['FraktionsRang'] == 0) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank0name']; ?></option>
                                <option value="1" <?php if($row_userdataall_db['FraktionsRang'] == 1) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank1name']; ?></option>
                                <option value="2" <?php if($row_userdataall_db['FraktionsRang'] == 2) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank2name']; ?></option>
                                <option value="3" <?php if($row_userdataall_db['FraktionsRang'] == 3) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank3name']; ?></option>
                                <option value="4" <?php if($row_userdataall_db['FraktionsRang'] == 4) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank4name']; ?></option>
                                <option value="5" <?php if($row_userdataall_db['FraktionsRang'] == 5) { echo "selected"; } else {} ?>><?php echo $row_fraktionen_db['rank5name']; ?></option>
                            </select>
                        </div>
                        <div class="box-footer">
                        	<button type="submit" class="btn btn-success">Rang ändern</button>
                        </div>
                        <input name="updaterang_name" type="hidden" value="<?php echo $editranguser; ?>">
                        <input type="hidden" name="MM_update" value="editrangform">
                     </form>
                  </div><!-- /.box -->
                    </div>
                    <div class="col-md-3"></div>
