...
if(getFraktionID($UName, $connection) == 0) { 
	$goto = "../../main.php";
...
<body class="hold-transition skin-yellow" style="overflow: hidden;">
    <div class="wrapper">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="#"><i class="fa fa-pencil-alt"></i> <span>Account Verwalten</span></a></li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
            <center><img src="<?php echo $row_ucp_fraktion_db['headerimage']; ?>" alt="fraktion-header-image"></center>
        </section>
            	...
            	<div class="col-md-4">
                	<div class="info-box bg-green">
  						...
  						<div class="info-box-content">
    						...
    						<span class="info-box-number"><?php echo getFraktionKasse(getFraktionID($UName, $connection), $connection); ?> €</span>
                            <span class="info-box-text">vom Etar noch übrig.</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                	<div class="info-box bg-navy">
  						...
  						<div class="info-box-content">
   							<span class="info-box-text">Es sind insgesamt</span>
    						<span class="info-box-number"><?php echo getFraktionMemberCount(getFraktionID($UName, $connection), $connection); ?></span>
                            <?php
                            	 if(getFraktionID($UName, $connection) == 1) #SAPD
							{
								echo '<span class="info-box-text">Officer mit Ihnen angestellt.</span>';
							}
							else if(getFraktionID($UName, $connection) == 2) #Camorra
							{
								echo '<span class="info-box-text">Mitglieder mit Ihnen im Baugewerbe.</span>';
							}
							else if(getFraktionID($UName, $connection) == 3) #Ballas
							{
								echo '<span class="info-box-text">Homies mit dir in der Gang.</span>';
							}
							else if(getFraktionID($UName, $connection) == 4) #Terroristen
							{
								echo '<span class="info-box-text">Brüder mit ihnen im Dschihad.</span>';
							}
							else if(getFraktionID($UName, $connection) == 5) #Liberty Tree Redaktion
							{
								echo '<span class="info-box-text">Mitarbeiter mit Ihnen in der Redaktion.</span>';
							}
							else if(getFraktionID($UName, $connection) == 6) #FBI
							{
								echo '<span class="info-box-text">Agenten mit Ihnen angestellt.</span>';
							}
							else if(getFraktionID($UName, $connection) == 7) #Seville Families
							{
								echo '<span class="info-box-text">Homies mit dir in der Gang.</span>';
							}
							else if(getFraktionID($UName, $connection) == 8) #Army
							{
								echo '<span class="info-box-text">Soldaten mit Ihnen verpflichtet.</span>';
							}
							else if(getFraktionID($UName, $connection) == 9) #Biker
							{
								echo '<span class="info-box-text">Brüder mit Ihnen im Club.</span>';
							}
							else if(getFraktionID($UName, $connection) == 10) #SAMC
							{
								echo '<span class="info-box-text">Mitglieder mit Ihnen im Medizinischen Notdienst.</span>'; 
							}?>
                            
                        </div>
                    </div>
                </div>
               <?php if(getFraktionRang($UName, $connection) > 4) { ?>
                <div class="col-md-4">
					<div class="box box-warning">
  						<div class="box-header with-border">
    						<h3 class="box-title">Fraktionsmannagement</h3>
  						</div><!-- /.box-header -->
                        <div class="box-body" style="list-style: none;">
    						<!-- <li><a href="rangnamen-editieren/">Rangnamen editieren</a></li> -->
                            <li><a href="mitarbeiter-verwalten/">Mitarbeiter verwalten</a></li>
                		</div><!-- /.box-body -->
					</div><!-- /.box -->
                </div>
                <?php } else {} ?>
                <div class="rows">
                	<?php if(getFraktionID($UName, $connection) == 1) { include("../../dist/includes/wanted.php"); } else
						  if(getFraktionID($UName, $connection) == 6) { include("../../dist/includes/wanted.php"); } else
						  if(getFraktionID($UName, $connection) == 8) { include("../../dist/includes/wanted.php"); } else
						  {}
					?>
                </div>
            </div>
